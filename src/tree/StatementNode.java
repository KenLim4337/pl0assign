...
public abstract class StatementNode {
    ...
    //Modify to handle multiple assignments
    ...
    public static class AssignmentNode extends StatementNode {
    	...
    	public void addAssignment( SingleAssignmentNode a ) {
            assignments.add( a );
        }
		...
		public String toString(int level) {
			...
			for (SingleAssignmentNode x: assignments) {
				result += x.toString() + "|";
			}
    ...
    /*
    	Bulk of changes, check AssignmentNode for other changes
    */
    ...
    public static class CaseNode extends StatementNode {
    	...
    	private ListNode def;
    	
		public CaseNode(Location loc) {
			super(loc);
			this.condition = null;
			this.branches = new ArrayList<BranchNode>();
			this.def = new ListNode(loc);
		}

		public void addCondition(ExpNode cond) {
			this.condition = cond;
		}
		
		public void addBranch(BranchNode branch) {
			this.branches.add(branch);
		}
		
		public void addDefault(StatementNode dflt) {
			this.def = (ListNode) dflt;
		}
		...
		public String toString(int level) {
			...
			String conditionz = "case" + condition + "of";
			
			String branchez = "";
			for (BranchNode x : branches){
				branchez += x.toString() + System.lineSeparator();
			}
			
			String defalt = def.toString();
			
			return conditionz + branchez + defalt;
    ...
    public static class BranchNode extends StatementNode {
		...
		public BranchNode(Location loc, ConstExp constant, ListNode list) {
			super(loc);
		...
		@Override
		public String toString(int level) {
			String statements = list.toString();
			return constant + System.lineSeparator() + statements;
		}
